...
INSERT INTO public.role_permissions (role, module, scope, can_create, can_read, can_update, can_delete) VALUES
  ...
  -- ─ HR ─
  ('hr', 'dashboard',            'all',    false, true,  false, false),
  ('hr', 'attendance',           'all',    false, true,  true,  false),
  ...
  ('hr', 'leave_approval',       'all',    true,  true,  true,  true),
  ('hr', 'rfid_devices',         'none',   false, false, false, false),
  ('hr', 'process_payroll',      'none',   false, false, false, false),
  ('hr', 'payroll_records',      'none',   false, false, false, false),
  ('hr', 'payslips',             'none',   false, false, false, false),
  ...
  ('hr', 'hr_reports',           'all',    true,  true,  true,  true),
  ...
  ('hr', 'timesheet',            'all',    false, true,  false, false),
  ...
  ('accountant', 'leave_approval',       'none',   false, false, false, false),
