...
-- decision in 20260924_revoke_hr_payroll_records.sql. That earlier audit flagged
...
-- automatically. Follows 20260919_revoke_accountant_leave_approval.sql and
-- 20260924_revoke_hr_payroll_records.sql.
--
-- WHAT REMAINS
...
-- (20260923_has_permission_respects_self_scope.sql), so this employee grant was
